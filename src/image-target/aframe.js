const {Controller, UI} = window.dybo.IMAGE;

AFRAME.registerSystem('dybo-image-system', {
  container: null,
  video: null,
...
AFRAME.registerComponent('dybo-image', {
  dependencies: ['dybo-image-system'],
  ...
  init: function() {
    const arSystem = this.el.sceneEl.systems['dybo-image-system'];
...
AFRAME.registerComponent('dybo-image-target', {
  dependencies: ['dybo-image-system'],
